...
export function AttestationTerminal() {
  ...
  return (
    <div className="card card-lit relative overflow-hidden shadow-lift" aria-hidden="true">
      <div className="flex items-center gap-2 border-b border-line bg-surface-sunk px-4 py-2.5">
        ...
        <span className="ml-auto flex items-center gap-1.5 font-mono text-[10.5px] uppercase tracking-[0.12em] text-ink-faint">
      ...
      {/*
       * A band of light crossing the record, slowly, forever. It is the one
       * ambient loop on the page and it earns its place: it says the enclave is
       * being read, not that a page is loading.
       */}
      <div className="pointer-events-none absolute inset-x-0 top-0 bottom-0 overflow-hidden">
        <div className="h-16 w-full animate-scan bg-gradient-to-b from-transparent via-flare/[0.07] to-transparent" />
      </div>

      <div className="relative space-y-2 px-4 py-6 font-mono text-[12.5px] sm:px-5 sm:text-[13px]">
        {lines.map((line) => {
      ...
      <div className="relative border-t border-line bg-surface-sunk px-4 py-3.5 sm:px-5">
