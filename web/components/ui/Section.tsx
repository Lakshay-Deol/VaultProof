...
export function SectionHeading({
  ...
  // Wrapped in a Reveal so the heading lifts in and its accent rule draws
  // itself — see `.reveal:not(.reveal-in) .accent-underline` in globals.css.
  return (
    <Reveal as="header" className={cx("max-w-2xl", className)}>
